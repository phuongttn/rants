...
from rants.configs import dataset_config
from rants.datasets import RANTSDataModule
from rants.models.rants import RANTS
from rants.utils.pylogger import get_pylogger
from rants.utils.misc import task_wrapper, log_hyperparameters
...
def train(cfg: DictConfig) -> Tuple[dict, dict]:
    ...
    datamodule = RANTSDataModule(cfg, dataset_cfg)
...
@hydra.main(version_base="1.2", config_path=str(root/"rants/configs_hydra"), config_name="train.yaml")
